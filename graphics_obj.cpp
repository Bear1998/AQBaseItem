        ...
        QGraphicsItem *item, QPainter *painter, const QStyleOptionGraphicsItem *option)
{
    ...
    painter->setPen(QPen(QColor("lightskyblue"), 2, Qt::SolidLine));
    painter->setBrush(Qt::NoBrush);
    painter->drawRect(item->boundingRect().adjusted(-pad, -pad, pad, pad));
...
void GraphicsRectItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    painter->drawLine(QLine(QPoint(center.x()-6,center.y()),QPoint(center.x()+6,center.y())));
    painter->drawLine(QLine(QPoint(center.x(),center.y()-6),QPoint(center.x(),center.y()+6)));
